<template>
  <div class="container min-h-[87vh]">
    <h1 class="text-center text-5xl font-bold pt-20">Contact</h1>
    <h2 class="text-center text-lg mt-3">
      Pour tout renseignement ou demande de devis
    </h2>

    <div class="block w-3/5 mx-auto my-10">
      <form ref="form" @submit.prevent="sendEmail">
        <div class="grid grid-cols-2">
          <div class="col-span-1 px-3 my-2">
...
const sendEmail = () => {
  ...
  if (isChecked) {
    emailjs.sendForm(config.ID, config.TEMPLATE, form.value, config.KEY).then(
      () => {
